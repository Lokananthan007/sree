      ...
      <div className="card-container">
        ...
        <Card className="card" data-animate="fade-in" data-delay="0.2s">
          ...
          <Card.Body>
            ...
            <Card.Text data-animate="fade-in" data-delay="0.2s">
              Create top-notch Android and iOS applications with intuitive design, smooth functionality, and reliable performance.
            </Card.Text>
            <button  className="custom-btn" data-animate="fade-in" data-delay="0.2s">Learn More</button>
          </Card.Body>
        </Card>
        ...
        <Card className="card" data-animate="fade-in" data-delay="0.2s">
          ...
          <Card.Body>
            ...
            <Card.Text data-animate="fade-in" data-delay="0.2s">
              Design and develop scalable, secure, and efficient software solutions tailored to meet business requirements effectively.
            </Card.Text>
            <button  className="custom-btn" data-animate="fade-in" data-delay="0.2s">Learn More</button>
          </Card.Body>
        </Card>
        ...
        <Card className="card" data-animate="fade-in" data-delay="0.2s">
          ...
          <Card.Body>
            ...
            <Card.Text data-animate="fade-in" data-delay="0.2s">
              Create responsive, modern websites with user-friendly interfaces, optimized performance, and seamless functionality across devices.
            </Card.Text>
            <button  className="custom-btn" data-animate="fade-in" data-delay="0.2s">Learn More</button>
          </Card.Body>
        </Card>
        ...
        <Card className="card" data-animate="fade-in" data-delay="0.2s">
          ...
          <Card.Body>
            ...
            <Card.Text data-animate="fade-in" data-delay="0.2s">
              Enhance brand visibility through strategic marketing, driving engagement, customer growth, and long-term business success.
            </Card.Text>
            <button  className="custom-btn" data-animate="fade-in" data-delay="0.2s">Learn More</button>
          </Card.Body>
        </Card>
